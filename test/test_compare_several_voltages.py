...
def test_compare_several_voltages():
    maximum_voltage_magnitude_difference, maximum_phase_angle_difference = \
        main(
            ...
            comparison_csv_list=[
                ROOT_PATH / 'data' / 'results' / 'Results HELM DS M1 PV2 case118 1.02 1e-08 buses.csv',
                ROOT_PATH / 'data' / 'results' / 'Results HELM DS M2 PV1 case118 1.02 1e-08 buses.csv',
                ROOT_PATH / 'data' / 'results' / 'Results HELM DS M2 PV2 case118 1.02 1e-08 buses.csv',
            ],
            print_all=False
        )
